...
namespace SurvivalPrep.Migrations.UsersRolesDBMigrations
{
    ...
    [Migration("20191201230102_AddDBReference")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurvivalPrep.DBModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurvivalPrep.DBModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurvivalPrep.DBModels.ItemInstance", b =>
                {
                    b.HasOne("SurvivalPrep.DBModels.ApplicationUser", "ApplicationUser")
                        .WithMany("OwnedItems")
