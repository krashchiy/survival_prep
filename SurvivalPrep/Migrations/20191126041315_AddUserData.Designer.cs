...
namespace SurvivalPrep.Migrations.UsersRolesDBMigrations
{
    ...
    [Migration("20191126041315_AddUserData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurvivalPrep.Areas.Identity.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SurvivalPrep.DBModels.ItemInstance", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ItemId", "ApplicationUserID");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurvivalPrep.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurvivalPrep.DBModels.ItemInstance", b =>
                {
                    b.HasOne("SurvivalPrep.Areas.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("OwnedItems")
